        ...
        <section class="grow">
            <section class="">
                <div class="flex items-center gap-8">
                    <p class="font-medium pb-2.5 text-slate-300 cursor-pointer hover:text-gray-800" onclick="showContent('film')">Film (<span><?= count($films) ?></span>)</p>
                    <p class="font-medium pb-2.5 text-slate-300 cursor-pointer hover:text-gray-800" onclick="showContent('bioskop')">Bioskop</p>
                </div>
            ...
            <div id="filmContent" class="content">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="max-w-md mx-auto border px-6 py-4 rounded-lg my-4">
            ...
            <div id="bioskopContent" class="content hidden">
                <section class="mt-6 flex flex-wrap justify-between gap-4">
                    <?php foreach ($bioskops as $bioskop) : ?>
                        <div class="max-w-[11rem] space-y-2 shadow p-2.5 group hover:bg-sky-500 rounded-md">
                            <a href="/bioskop/<?= $bioskop['id'] ?>" class="inline-block">
                                <img src="<?= $bioskop['image'] ?>" alt="" class="w-full">
                            </a>
                            <div class="flex items-end justify-between">
                                <div class="w-1/2">
                                    <p class="group-hover:text-white text-slate-500 text-xs truncate"><?= $bioskop['nama'] ?></p>
                                </div>
                                <p class="group-hover:text-white font-semibold text-xs text-slate-500 shrink-0">facility: <?= $bioskop['fasilitas'] ?></p>
                            </div>
                            <div>
                                <p class="group-hover:text-white line-clamp-2 text-sm">loc: <?= $bioskop['lokasi'] ?></p>
                            </div>
                        </div>
                    <?php endforeach ?>
                </section>
