    ...
    <section class="">
      <section class="mt-6 flex flex-col lg:flex-row gap-12">
        ...
        <div class="space-y-7 lg:w-1/2">
          ...
          <div>
            <p class="text-[17px] font-medium">Detail Film</p>
            <table class="mt-2 text-[15px] border-separate border-spacing-2 w-full">
              <tbody>
                <tr>
                  <td class="font-medium text-sky-700 align-top">Studio</td>
                ...
                <tr>
                  <td class="font-medium text-sky-700 align-top">Jadwal</td>
                  <td class="align-top">:</td>
                  <td><?= $schedule['date'] ?> // <?= $schedule['time'] ?></td>
                </tr>
                <tr>
                  <td class="font-medium text-sky-700 align-top">Sinopsis</td>
                  <td class="align-top">:</td>
    ...
    <!-- <table class="table table-bordered table-hover mt-2">
      ...
      <tbody>
        <tr>
          ...
          <td><?= $transaction['film_id'] ?></td>
          <td><?= $transaction['total_price'] ?></td>
          <td><?= $transaction['count'] ?></td>
          <td><img src="<?= $film['cover'] ?>"></td>
          <td><?= $film['title'] ?></td>
        </tr>
      </tbody>
    </table> -->
